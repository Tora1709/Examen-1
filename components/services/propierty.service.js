(function() {
  ...
  function propiertyService() {
    ...
    function _setPropierties(pPropierties) {
      ...
      propiertiessList.push(pPropierties);
    ...
    function _getPropierties() {
      var propiertiesList = JSON.parse(localStorage.getItem('lsPropiertiesList'));
      if (propiertiesList == null) {
        propiertiesList = propierties;
      }
      return propiertiesList;
    }
